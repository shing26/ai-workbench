    ...
    <div className="flex h-full w-full">
      ...
      >
        <div className="px-3 pt-3 pb-1">
          ...
          <div className="mb-3">
            <span
              className="text-[9px] font-medium uppercase mb-1.5 block"
              style={{ color: 'var(--color-text-muted)' }}
            >
              Source
            </span>
            <div className="flex flex-wrap gap-1">
              <button
                ...
                style={{
                  background: !sourceFilter ? 'var(--color-accent-muted)' : 'transparent',
                  color: !sourceFilter ? 'var(--color-accent)' : 'var(--color-text-muted)',
                  border: !sourceFilter
              ...
              {sources.map((s) => (
                <button
                  ...
                  className="px-2 py-1 rounded text-[10px] transition-colors"
                  style={{
                    background: sourceFilter === s ? 'var(--color-accent-muted)' : 'transparent',
                    color: sourceFilter === s ? 'var(--color-accent)' : 'var(--color-text-muted)',
                    border:
                      sourceFilter === s
                        ? '1px solid rgba(16,185,129,0.3)'
                        : '1px solid transparent',
            ...
            <div className="flex gap-1">
              {['urgent', 'quiet'].map((l) => (
                <button
                  ...
                  style={{
                    background: levelFilter === l ? 'var(--color-accent-muted)' : 'transparent',
                    color:
                      levelFilter === l
                        ? 'var(--color-accent)'
                        : l === 'urgent'
            ...
            filtered.map((evt) => (
              ...
              >
                <span
                  ...
                  style={{
                    color:
                      evt.level === 'urgent' ? 'var(--color-error)' : 'var(--color-text-muted)',
                  }}
                >

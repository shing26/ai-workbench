...
export default function MonetizationView() {
  const projects = useMonetizationStore((s) => s.projects);
  const monthlyRevenue = useMonetizationStore((s) => s.monthlyRevenue);
          ...
          <div className="max-w-3xl mx-auto">
            <div className="grid grid-cols-3 gap-3 mb-6">
              {[
                ...
                { label: 'Growth', value: `+${0}%`, icon: TrendingUp },
                {
                  ...
                  value: projects.length.toString().toString(),
                  icon: BarChart3,
                },
              ].map((card) => (
                <div
            ...
            >
              ...
              <p className="text-[12px] mb-4" style={{ color: 'var(--color-text-muted)' }}>
                Turn your ideas into revenue streams. Start by describing a product concept.
              </p>
              <button

                ...
                <div className="flex flex-col items-center pt-2 shrink-0" style={{ width: '20px' }}>
                  ...
                  {i < phases.length - 1 && (
                    <div
                      ...
                      style={{
                        background: done ? 'var(--color-accent)' : 'var(--color-border-subtle)',
                      }}
                    />
                  )}
                </div>
                <div
                  className="flex-1 px-2.5 py-2 rounded-[var(--radius-sm)]"
                  style={{
                ...
                >
                  <div className="flex items-center gap-1.5">
                    <p.icon
                      size={14}
                      style={{
                        color: done || active ? 'var(--color-accent)' : 'var(--color-text-muted)',
                      }}
                    />
                    <span
                      ...
                      style={{
                        color:
                          done || active ? 'var(--color-text-primary)' : 'var(--color-text-muted)',
                      }}
                    >
                      {p.label}
                    </span>
          ...
          {phase === 'idle' ? (
            <div className="max-w-xl mx-auto mt-16">
              ...
              >
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-transparent resize-none outline-none text-sm px-3 py-2 rounded-[var(--radius-md)] mb-4"
                  style={{
                ...
                <button
                  ...
                  disabled={!input.trim()}
                  className="px-4 py-2 rounded-[var(--radius-md)] text-[13px] font-medium transition-all duration-150 active:scale-[0.98] disabled:opacity-30"
            ...
            <div className="max-w-xl mx-auto mt-16">
              ...
              >
                ...
                <p className="text-[12px] mb-4" style={{ color: 'var(--color-text-muted)' }}>
                  Answer these questions to help the AI understand better:
                </p>
                <div className="space-y-3">
                  {[
                    { q: 'What platform is this for?', opts: ['Web', 'CLI', 'Desktop', 'Mobile'] },
                  ].map((cq, i) => (
                    <div
                      key={i}
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {cq.opts.map((opt) => (
                          <button
                            key={opt}
                            onClick={() => selectClarification(i, opt)}
                ...
                <button
                  onClick={startImplementing}
                  className="mt-4 px-4 py-2 rounded-[var(--radius-md)] text-[13px] font-medium transition-all duration-150 active:scale-[0.98]"
                  style={{ background: 'var(--color-accent)', color: '#121214' }}
                >
            ...
            <div className="max-w-2xl mx-auto">
              ...
              >
                ...
                <pre
                  ref={codeRef}
                  className="code-block px-4 py-3 overflow-x-auto whitespace-pre-wrap text-sm"
                  style={{
                    color: 'var(--color-text-primary)',
              ...
              {(phase === 'done' || phase === 'accepted') && (
                <div className="flex gap-2 mt-4">
                  <button
                    ...
                    className="px-4 py-2 rounded-[var(--radius-md)] text-[13px] font-medium transition-all duration-150 active:scale-[0.98]"
                    style={{ background: 'var(--color-accent)', color: '#121214' }}
                  >
                    Accept and Finish
                  </button>
                  <button
                    ...
                    className="px-4 py-2 rounded-[var(--radius-md)] text-[13px] transition-all duration-150 active:scale-[0.98]"
                    style={{
                      background: 'var(--color-surface-hover)',
                      color: 'var(--color-text-secondary)',
                      border: '1px solid var(--color-border)',

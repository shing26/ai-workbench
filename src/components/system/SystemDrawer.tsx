  ...
  return (
    ...
    >
      <div className="flex shrink-0 items-center justify-between gap-2 border-b border-white/10 px-4 py-3">
        <div className="min-w-0">
          ...
          <p className="truncate text-[10px] text-slate-500">
            Webhook · Sync · Event bus · Agent · 明细配置
          </p>
        </div>
        <button
          type="button"
      ...
      >
        ...
        <section
          id="system-drawer-webhook"
          data-system-drawer-section="webhook"
          className="scroll-mt-2"
        >
          <BentoCard
          ...
          >
            ...
            {webhookTemplateValidation && (
              ...
              >
                {webhookTemplateValidation.ok
                  ? 'valid'
                  : webhookTemplateValidation.errors.join('; ')}
                {' · '}
                    ...
                    >
                      {
                        webhookRuleRuns.filter(
                          (run) =>
                            run.status === 'failed' && Date.now() - run.createdAt <= 86_400_000,
                        ).length
                      }{' '}
                      failed run(s) in 24h
                    </span>
                ...
                <div data-webhook-rule-runs className="space-y-1">
                  ...
                  {webhookRuleRuns.slice(0, 8).map((run) => {
                    ...
                    return (
                      ...
                      >
                        <span className="max-w-32 truncate text-[9px] text-slate-300">
                          {ruleName}
                        </span>
                        <span
                        ...
                        <span
                          data-webhook-rule-run-time
                          className="ml-auto text-[8px] text-slate-600"
                        >

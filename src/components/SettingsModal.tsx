          ...
          >
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-2">
                <span className="w-1.5 h-5 rounded-full" style={{ background: "var(--color-accent)" }} />
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-[var(--radius-md)]" style={{ background: "var(--color-bg-tertiary)", border: "1px solid var(--color-border-subtle)" }}>
                <div className="flex items-center gap-2 mb-3">
                  <Folder size={14} style={{ color: "var(--color-accent)" }} />
                  <label className="text-xs font-medium" style={{ color: "var(--color-text-secondary)" }}>Obsidian Vault Path</label>
                </div>
                <div className="flex gap-2">
                  <div className="flex-1 flex items-center gap-2 px-3 py-2 rounded-[var(--radius-sm)]" style={{ background: "var(--color-bg-secondary)", border: "1px solid var(--color-border)" }}>
                    <input
                      value={input}
                ...
                <p className="text-[10px] mt-2" style={{ color: "var(--color-text-muted)" }}>
                  Enter the absolute path to your Obsidian vault folder. Notes will be saved here as .md files.
                </p>
              </div>
